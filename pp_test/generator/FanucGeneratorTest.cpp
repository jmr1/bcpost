...
static void verify(std::vector<pp::interface::AttributeVariant>&& av, std::string&& data_expected, bool ret_expected)
{
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE("generate(): returned generated string not equal", data_expected, data);
}
